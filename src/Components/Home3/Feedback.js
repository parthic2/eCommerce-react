...
import author1 from "../../Assets/img/testimonial/author-1-1.png";
import author2 from "../../Assets/img/testimonial/author-2-1.png";
import author3 from "../../Assets/img/testimonial/author-3-1.png";
import line from "../../Assets/img/svg/InnerLine.svg";

const Feedback = () => {
  return (
    <div
      className="rbt-splash-testimonial-area bg-color-white overflow-hidden position-relative"
    >
      <div className="container">
        <div className="row align-items-end">
          ...
          <div
            className="col-xl-5 col-lg-5 col-md-6 d-none d-md-block align-self-center"
          >
                ...
                <div className="inner">
                  <div className="clint-info-wrapper">
                    ...
                    <div className="client-info">
                      <h1 className="title">Mathias Herasen</h1>
                  ...
                  <div className="description">
                    <p className="subtitle-3">
                      ...
                      to the pricing model primchat great for us.”
                    </p>
              ...
              <div className="rbt-testimonial-box style-2">
                <div className="inner">
                  <div className="clint-info-wrapper">
                    ...
                    <div className="client-info">
                      <h1 className="title">Daniel Lei</h1>
                      <span>Founder of <b>GamerPay</b></span>
                    </div>
                  </div>
                  <div className="description">
                    <p className="subtitle-3">
                      ...
                      template super easy to use. Very helpful support team
                      too.
                    </p>
                    <div className="icons mt-15">
                      <img
              ...
              <div className="rbt-testimonial-box style-2">
                <div className="inner">
                  <div className="clint-info-wrapper">
                    ...
                    <div className="client-info">
                      <h1 className="title">Rodney Parker</h1>
                      <span>Founder of <b>GamerPay</b></span>
                    </div>
                  </div>
                  <div className="description">
